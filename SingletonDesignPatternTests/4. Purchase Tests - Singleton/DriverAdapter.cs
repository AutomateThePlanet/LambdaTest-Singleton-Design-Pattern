...
{
    // non-thread safe
    //private static DriverAdapter _instance;
    //public static DriverAdapter Instance
    //{
    //    get
    //    {
    //        if (_instance == null)
    //        {
    //            _instance = new DriverAdapter();
    //        }
    //        return _instance;
    //    }
    //}
    ...
    // thread safe
    private static Lazy<DriverAdapter> _instance = new Lazy<DriverAdapter>(() => new DriverAdapter());
